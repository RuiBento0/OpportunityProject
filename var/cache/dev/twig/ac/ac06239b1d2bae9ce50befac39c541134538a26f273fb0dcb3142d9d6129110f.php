...
class __TwigTemplate_3010b886d067257e0fd77aa1a022fab6901e2ded86a60ab2e3da7c0e7d5d4e1d extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function macro_dump_request_data($__token__ = null, $__events__ = null, $__origin__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            // line 156
            $macros["__internal_parse_17"] = $this;
            // line 157
            echo "{
    id: \"";
            // line 158
    ...
    events: [ ";
            // line 161
            echo twig_call_macro($macros["__internal_parse_17"], "macro_dump_events", [(isset($context["events"]) || array_key_exists("events", $context) ? $context["events"] : (function () { throw new RuntimeError('Variable "events" does not exist.', 161, $this->source); })())], 161, $context, $this->getSourceContext());
            echo " ],
}
";
...
{% endmacro %}
", "@WebProfiler/Collector/time.html.twig", "C:\\Users\\RuiMiguelCarvalhoBen\\Documents\\symfony-cli\\my_project\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\time.html.twig");
    }
}
