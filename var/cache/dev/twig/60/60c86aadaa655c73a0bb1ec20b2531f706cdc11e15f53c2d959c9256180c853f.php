...
class __TwigTemplate_adae3950dd4223de8791508174160512f86c4b4bbebd5ccf9733802b0687e231 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"page-wrapper\">
        ...
        echo "
                                        ...
                                        <div class=\"form-group\">
                                            <button type=\"submit\" style=\"float:right; margin-right:15px\" class=\"btn btn-de-success btn-sm text-light px-4 mt-3 mb-0\">Update</button>                                                                                                                                                                                     
                                        </div>
                                        ";
        // line 59
                    ...
                    <div class=\"row\">
                        <div class=\"col-sm-12\">
                            <div class=\"page-title-box\">
                                ...
                                <h4 class=\"page-title\">Edit {{ accountstype.name }}</h4>
                            </div><!--end page-title-box-->
                        </div><!--end col-->
                    </div>
                    <!-- end page title end breadcrumb -->
