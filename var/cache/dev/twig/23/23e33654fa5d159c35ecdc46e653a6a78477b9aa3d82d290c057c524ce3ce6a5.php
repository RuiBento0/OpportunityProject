...
class __TwigTemplate_1148d057848d6682be1b738ad3d99d10eeec920ec265e1b54b95f818809a34d0 extends Template
{
    private $source;
    private $macros = [];
                    ...
                    <div class=\"row\">
                        <div class=\"col-sm-12\">
                            <div class=\"page-title-box\">
                                ...
                                <h4 class=\"page-title\">{% trans %}Campaign{% endtrans %} {{ campaign.name }}</h4>
                            </div><!--end page-title-box-->
                        </div><!--end col-->
                    </div>
                    <!-- end page title end breadcrumb -->
