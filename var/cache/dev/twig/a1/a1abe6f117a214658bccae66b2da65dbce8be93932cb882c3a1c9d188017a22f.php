...
class __TwigTemplate_371cbedae14422d2af5300982dfe1d2c22b56e63cb7752cbb4567ebe0b986677 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "options/stages.html.twig"));
   ...
   <div class=\"page-wrapper\">
        ...
        echo "</h4>
                        ...
                        <form action=\"/options/stages/create\">
                                ...
                                <div class=\"card-header\">
                                    <div class=\"row align-items-center\">
                                        <div class=\"col\">                      
                                            <h4 class=\"card-title\">";
        // line 41
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Stages Details", [], "messages");
        echo "</h4>             
                                        </div><!--end col-->                                       
                                    </div>  <!--end row-->                                  
                                </div><!--end card-header-->
        ...
        $context['_seq'] = twig_ensure_traversable($context["stages"]);
        foreach ($context['_seq'] as $context["_key"] => $context["stages"]) {
            // line 59
            echo "
                                                        <td style=\"vertical-align: middle\">";
            // line 60
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["stages"], "id", [], "any", false, false, false, 60), "html", null, true);
            echo "</td>
                                                        <td style=\"vertical-align: middle\">";
            // line 61
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["stages"], "name", [], "any", false, false, false, 61), "html", null, true);
            echo "</td>
            ...
            if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, true, false, 66), "id", [], "any", true, true, false, 66)) {
                // line 67
                echo "                                                        <a href=\"stages/show/";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["stages"], "id", [], "any", false, false, false, 67), "html", null, true);
                echo "\"><i class=\"mdi mdi-eye-outline text-secondary font-16\"></i></a>
                                                        <a href=\"stages/edit/";
                // line 68
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["stages"], "id", [], "any", false, false, false, 68), "html", null, true);
                echo "\"><i class=\"las la-pen text-secondary font-16\"></i></a>
                                                        <a href=\"stages/delete/";
                // line 69
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["stages"], "id", [], "any", false, false, false, 69), "html", null, true);
        ...
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['stages'], $context['_parent'], $context['loop']);
                            ...
                            <div class=\"page-title-box\">
                                <div class=\"float-end\">
                                    <ol class=\"breadcrumb\">
                                        ...
                                        <li class=\"breadcrumb-item active\"{% trans %}>Stages{% endtrans %}</li>
                                    </ol>
                                </div>
                        ...
                        <div class=\"col-12\">
                            <div class=\"card\">
                                <div class=\"card-header\">
                                    <div class=\"row align-items-center\">
                                        <div class=\"col\">                      
                                            <h4 class=\"card-title\">{% trans %}Stages Details{% endtrans %}</h4>             
                                        </div><!--end col-->                                       
                                    </div>  <!--end row-->                                  
                                </div><!--end card-header-->
                                <div class=\"card-body\">                                    
                                        ...
                                        <table class=\"table mb-0\">
                                            ...
                                            <tbody id=\"myTable\">
                                                    ...
                                                    {% for stages in stages %}
                                                        ...
                                                        <td style=\"vertical-align: middle\">{{ stages.id }}</td>
                                                        <td style=\"vertical-align: middle\">{{ stages.name }}</td>


                                                        <td style=\"-webkit-user-select: none; vertical-align: middle\">

                                                        {% if app.user.id is defined%}
                                                        <a href=\"stages/show/{{ stages.id }}\"><i class=\"mdi mdi-eye-outline text-secondary font-16\"></i></a>
                                                        <a href=\"stages/edit/{{ stages.id }}\"><i class=\"las la-pen text-secondary font-16\"></i></a>
                                                        <a href=\"stages/delete/{{ stages.id }}\"><i class=\"las la-trash-alt text-secondary font-16\" onclick=\"return confirm('are you sure?')\"></i></a>
                                                        {% endif %}
                                                        </td>
                                                    </tr>
                                                    {% endfor %}
