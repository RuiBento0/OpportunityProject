...
class __TwigTemplate_8087f3b61c1fca3dc119593219f76693bdad5e4bf53312c1ffe163a004843f52 extends Template
{
    private $source;
    private $macros = [];
                            ...
                            <div class=\"page-title-box\">
                                <div class=\"float-end\">
                                    <ol class=\"breadcrumb\">
                                        ...
                                        <li class=\"breadcrumb-item\"><a href=\"/authentication/roles\">Role</a>
                                        </li><!--end nav-item-->
                    ...
                    <div class=\"row\">
                        <div class=\"col-sm-12\">
                            <div class=\"page-title-box\">
                                ...
                                <h4 class=\"page-title\">Edit {{ role.role }}</h4>
                            </div><!--end page-title-box-->
                        </div><!--end col-->
                    </div>
                    <!-- end page title end breadcrumb -->
