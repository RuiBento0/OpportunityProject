...
class __TwigTemplate_11ef860c7a51b68fa831506d4542fbf15782e60b0a30219d68c88386eaabf48d extends Template
{
    private $source;
    private $macros = [];
                                ...
                                <div class=\"card-body p-0\">
                                    <div class=\"text-center p-3\">
                                        <a href=\"/login\" class=\"logo logo-admin\">
                                            <img src=\"img/business.png\" height=\"50\" alt=\"logo\" class=\"auth-logo\">
                                        </a>
                                        <h4 class=\"mt-3 mb-1 fw-semibold font-18\">Business</h4>   
                                        <p class=\"text-muted  mb-0\">";
        // line 28
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Sign in to continue.", [], "messages");
        echo "</p>  
                                    </div>
                                </div><!--end card-body-->
                                        ...
                                        <div class=\"form-group mb-0 row\" >
                                            <div class=\"col-12\" >
                                                <div class=\"d-grid mt-3\" >
                                                    <button class=\"btn btn-primary\" type=\"submit\" style=\"background-color:#608E34 ; border-color:#608E34\" >";
        // line 75
...
";
    ...
    {
        return array (  199 => 6,  197 => 5,  187 => 4,  174 => 105,  163 => 94,  149 => 75,  139 => 68,  128 => 60,  100 => 35,  90 => 28,  72 => 12,  70 => 4,  67 => 3,  48 => 2,  45 => 1,);
    }
                            ...
                            <div class=\"card mb-0 border-0\">
                                <div class=\"card-body p-0\">
                                    <div class=\"text-center p-3\">
                                        ...
                                        <h4 class=\"mt-3 mb-1 fw-semibold font-18\">Business</h4>   
                                        <p class=\"text-muted  mb-0\">{% trans %}Sign in to continue.{% endtrans %}</p>  
                                    </div>
                                </div><!--end card-body-->
                                <div class=\"card-body pt-0\">                                    
                                    <form action=\"/login\"class=\"my-4\" method=\"POST\">  
                                        ...
                                        <div class=\"form-group mb-0 row\" >
                                            <div class=\"col-12\" >
                                                <div class=\"d-grid mt-3\" >
                                                    <button class=\"btn btn-primary\" type=\"submit\" style=\"background-color:#608E34 ; border-color:#608E34\" >{% trans %}Log In {% endtrans %}<i class=\"fas fa-sign-in-alt ms-1\" ></i></button>
                                                </div>
                                            </div><!--end col--> 
                                        </div> <!--end form-group-->                           
                                    </form><!--end form-->
