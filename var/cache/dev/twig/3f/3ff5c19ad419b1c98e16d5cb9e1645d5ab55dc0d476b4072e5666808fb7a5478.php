...
class __TwigTemplate_6e9fa0e767f8cbd971d121dcd05f8ab152668856738f0c872e3d52cc0590d409 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "options/categories.html.twig"));
   ...
   <div class=\"page-wrapper\">
        ...
        // line 31
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Create Category", [], "messages");
        echo "</button>
                        </form>
                        </div>
                                ...
                                <div class=\"card-header\">
                                    <div class=\"row align-items-center\">
                                        <div class=\"col\">                      
                                            <h4 class=\"card-title\">";
        // line 41
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Categories Details", [], "messages");
        echo "</h4>             
                                        </div><!--end col-->                                       
                                    </div>  <!--end row-->                                  
                                </div><!--end card-header-->
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["category"]) {
            ...
            echo "</td>
                                                        <td style=\"vertical-align: middle\">";
            // line 63
            if ((twig_get_attribute($this->env, $this->source, $context["category"], "active", [], "any", false, false, false, 63) == 1)) {
                echo "Active";
            }
            if ((twig_get_attribute($this->env, $this->source, $context["category"], "active", [], "any", false, false, false, 63) == 0)) {
                echo "Disable";
            }
            echo "</td>
            ...
            if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, true, false, 67), "id", [], "any", true, true, false, 67)) {
                ...
                // line 69
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["category"], "id", [], "any", false, false, false, 69), "html", null, true);
