...
/* area/edit.html.twig */
class __TwigTemplate_869108ece3a3c4e8e3f42454e71c32cbcce6028c5049583e3f83179b049495e8 extends Template
{
    private $source;
    private $macros = [];
                            ...
                            <div class=\"page-title-box\">
                                <div class=\"float-end\">
                                    <ol class=\"breadcrumb\">
                                        ...
                                        <li class=\"breadcrumb-item\"><a href=\"/options/\">Area</a>
                                        </li><!--end nav-item-->
                    ...
                    <div class=\"row\">
                        <div class=\"col-sm-12\">
                            <div class=\"page-title-box\">
                                ...
                                <h4 class=\"page-title\">Edit {{ area.name }}</h4>
                            </div><!--end page-title-box-->
                        </div><!--end col-->
                    </div>
                    <!-- end page title end breadcrumb -->
