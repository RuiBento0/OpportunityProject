...
/* opportunities/new.html.twig */
class __TwigTemplate_75ffce230f1a520179eb5c86f63a81ea3c7a485429e6d86e6e8f5362b3665b29 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "opportunities/new.html.twig"));

        $this->parent = $this->loadTemplate("base.html.twig", "opportunities/new.html.twig", 1);
                            ...
                            <div class=\"page-title-box\">
                                <div class=\"float-end\">
                                    <ol class=\"breadcrumb\">
                                        ...
                                        <li class=\"breadcrumb-item\"><a href=\"/opportunities\">Opportunities</a>
                                        </li><!--end nav-item-->
                                        ...
                                        <div class=\"col-lg-6\">
                                            <form>
                                                <div class=\"form-group\">
                                                    ...
                                                    <input type=\"text\" class=\"form-control\" id=\"OpportunitytName\" aria-describedby=\"emailHelp\" placeholder=\"Enter Opportunity name\">
                                                </div><!--end form-group-->
                                                <div class=\"form-group\">
                                                    <div class=\"row\">
                                                        <div class=\"col-lg-3 col-6 mb-2 mb-lg-0\">
                                                            <label class=\"form-label mt-2\" for=\"pro-amount\">Amount</label>
                                                            <input type=\"text\" class=\"form-control\" id=\"pro-amount\" placeholder=\"Enter amount\">
                                                        </div><!--end col-->
                                                        <div class=\"col-lg-3 col-6 mb-2 mb-lg-0\">
                                                        ...
                                                        <div class=\"col-lg-3 col-6\">
                                                            <label class=\"form-label mt-2\" for=\"pro-probability\">Probability</label>
                                                            <input type=\"text\" class=\"form-control\" id=\"pro-probability\" placeholder=\"Enter prob\">
                                                        </div><!--end col-->
                                                        <div class=\"col-lg-3 col-6\">
                                                ...
                                                <div class=\"form-group\">
                                                    <div class=\"row\">
                                                        <div class=\"col-lg-6 mb-2 mb-lg-0\">
                                                            <label class=\"form-label mt-2\" for=\"pro-end-date\">Account</label>
                                                            <select class=\"form-select\">
                                                                <option>--Select--</option>
                                                        ...
                                                        <div class=\"col-lg-6 mb-2 mb-lg-0\">
                                                            <label class=\"form-label mt-2\" for=\"pro-department\">Department</label>
                                                            <select class=\"form-select\">
                                                                <option>--Select--</option>
                                                                <option>UI/UX Design</option>
                                                                <option>Payment System </option>
                                                ...
                                                <button type=\"submit\" class=\"btn btn-de-primary btn-sm\">Create Opportunity</button>
...
";
    ...
    {
        return "opportunities/new.html.twig";
    }
...
{% endblock %}", "opportunities/new.html.twig", "C:\\Users\\RuiMiguelCarvalhoBen\\Documents\\symfony-cli\\my_project\\templates\\opportunities\\new.html.twig");
    }
}
