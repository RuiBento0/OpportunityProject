...
class __TwigTemplate_73691012a4925678a551d0decbf9967ee46e5f6efa38feffc1368ba0a6dfa708 extends Template
{
    private $source;
    private $macros = [];
                            ...
                            <div class=\"page-title-box\">
                                <div class=\"float-end\">
                                    <ol class=\"breadcrumb\">
                                        ...
                                        <li class=\"breadcrumb-item\"><a href=\"/options/priorities\">Priorities</a>
                                        </li><!--end nav-item-->
                    ...
                    <div class=\"row\">
                        <div class=\"col-sm-12\">
                            <div class=\"page-title-box\">
                                ...
                                <h4 class=\"page-title\">Edit {{ priorities.name }}</h4>
                            </div><!--end page-title-box-->
                        </div><!--end col-->
                    </div>
                    <!-- end page title end breadcrumb -->
