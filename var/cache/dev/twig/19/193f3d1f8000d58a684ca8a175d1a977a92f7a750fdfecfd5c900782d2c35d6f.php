...
class __TwigTemplate_8cc69bfbbdf9ba52f5ec2392d716e22eeafbe79d3ed894e59d1fea4add1c430e extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_previous_page_message($context, array $blocks = [])
    {
        ...
        // line 5
        echo twig_call_macro($macros["__internal_parse_12"], "macro_resolve_previous_page_message", [(isset($context["options"]) || array_key_exists("options", $context) ? $context["options"] : (function () { throw new RuntimeError('Variable "options" does not exist.', 5, $this->source); })())], 5, $context, $this->getSourceContext());
    ...
    public function block_next_page_message($context, array $blocks = [])
    {
        ...
        // line 10
        echo twig_call_macro($macros["__internal_parse_13"], "macro_resolve_next_page_message", [(isset($context["options"]) || array_key_exists("options", $context) ? $context["options"] : (function () { throw new RuntimeError('Variable "options" does not exist.', 10, $this->source); })())], 10, $context, $this->getSourceContext());
...
", "@BabDevPagerfanta/twitter_bootstrap4.html.twig", "C:\\Users\\RuiMiguelCarvalhoBen\\Documents\\symfony-cli\\my_project\\vendor\\babdev\\pagerfanta-bundle\\templates\\twitter_bootstrap4.html.twig");
    }
}
