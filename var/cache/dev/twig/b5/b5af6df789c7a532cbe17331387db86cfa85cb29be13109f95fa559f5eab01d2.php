   ...
   <div class=\"page-wrapper\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["area"]) {
            ...
            echo "</td>
                                    <td style=\"vertical-align: middle\">";
            // line 63
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["area"], "active", [], "any", false, false, false, 63), "html", null, true);
            echo "</td>
            ...
            if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, true, false, 67), "id", [], "any", true, true, false, 67)) {
                // line 68
                echo "                                    <a href=\"area/show\"><i class=\"mdi mdi-eye-outline text-secondary font-16\"></i></a>
                                    <a href=\"area/edit\"><i class=\"las la-pen text-secondary font-16\"></i></a>
                                    <a href=\"area/delete\"><i class=\"las la-trash-alt text-secondary font-16\"></i></a>
                                    ";
            }
            // line 72
            echo "                                    </td>
                    ...
                    <div class=\"row\" style=\"width: 90%; margin: auto;\">
                        ...
                        <tbody id=\"myTable\">
                            ...
                            {% for area in area %}
                                    ...
                                    <td style=\"vertical-align: middle\">{{ area.active }}</td>

                                    <td style=\"-webkit-user-select: none; vertical-align: middle\">
  
                                    {% if app.user.id is defined%}
                                    <a href=\"area/show\"><i class=\"mdi mdi-eye-outline text-secondary font-16\"></i></a>
                                    <a href=\"area/edit\"><i class=\"las la-pen text-secondary font-16\"></i></a>
                                    <a href=\"area/delete\"><i class=\"las la-trash-alt text-secondary font-16\"></i></a>
                                    {% endif %}
                                    </td>
