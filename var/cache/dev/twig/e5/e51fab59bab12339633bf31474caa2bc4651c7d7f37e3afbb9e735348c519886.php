...
class __TwigTemplate_7f84d2faf779bd305725e2ef6fdda025b472f6f9194006e4f2af56050c68c93e extends Template
{
    private $source;
    private $macros = [];
                    ...
                    <div class=\"row\">
                        <div class=\"col-sm-12\">
                            <div class=\"page-title-box\">
                                ...
                                <h4 class=\"page-title\">{% trans %}Edit{% endtrans %} {{ categories.name }}</h4>
                            </div><!--end page-title-box-->
                        </div><!--end col-->
                    </div>
                    <!-- end page title end breadcrumb -->
