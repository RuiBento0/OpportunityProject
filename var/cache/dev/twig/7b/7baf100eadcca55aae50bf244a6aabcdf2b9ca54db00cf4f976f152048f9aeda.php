...
class __TwigTemplate_063503f6f7b6d63f5fdc3325ae32a23fca15cc3589d577595fb5d81ce8f89bdc extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"page-wrapper\">
        ...
        echo "</a>
                                        ...
                                        <li class=\"breadcrumb-item\"><a href=\"/options/locations\">";
        // line 21
        ...
        echo "</li>
                                ...
                                <h4 class=\"page-title\">";
        // line 26
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Create New Location", [], "messages");
        echo "</h4>
                            ...
                            <div class=\"page-title-box\">
                                <div class=\"float-end\">
                                    <ol class=\"breadcrumb\">
                                        ...
                                        <li class=\"breadcrumb-item\"><a href=\"/options/locations\">{% trans %}Locations{% endtrans %}</a>
                                        </li><!--end nav-item-->
                                        <li class=\"breadcrumb-item active\">{% trans %}Create{% endtrans %}</li>
                                    </ol>
                                </div>
                                <h4 class=\"page-title\">{% trans %}Create New Location{% endtrans %}</h4>
                            </div><!--end page-title-box-->
                        </div><!--end col-->
                    </div>
                    <!-- end page title end breadcrumb -->
...
{% endblock %}", "locations/create.html.twig", "C:\\Users\\RuiMiguelCarvalhoBen\\Documents\\symfony-cli\\my_project\\templates\\locations\\create.html.twig");
    }
}
