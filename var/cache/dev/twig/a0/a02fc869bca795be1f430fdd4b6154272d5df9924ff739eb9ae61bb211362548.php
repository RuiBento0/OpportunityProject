...
/* options/status.html.twig */
class __TwigTemplate_7b25521f588ec3ee31c5117e6a1d57b06a42937d31dffd598b49fd9a637f82ce extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "options/status.html.twig"));

        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02 = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "options/status.html.twig"));

        $this->parent = $this->loadTemplate("base.html.twig", "options/status.html.twig", 1);
   ...
   <div class=\"page-wrapper\">
        ...
        echo "</h4>
                        ...
                        <form action=\"/options/status/create\">
        ...
        // line 31
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Create Status", [], "messages");
        echo "</button>
                        </form>
                        </div>
                                ...
                                <div class=\"card-header\">
                                    <div class=\"row align-items-center\">
                                        <div class=\"col\">                      
                                            <h4 class=\"card-title\">";
        // line 41
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Status Details", [], "messages");
        echo "</h4>             
                                        </div><!--end col-->                                       
                                    </div>  <!--end row-->                                  
                                </div><!--end card-header-->
        ...
        $context['_seq'] = twig_ensure_traversable($context["status"]);
        foreach ($context['_seq'] as $context["_key"] => $context["status"]) {
            // line 60
            echo "                            
                                                        <td style=\"vertical-align: middle\">";
            // line 61
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["status"], "id", [], "any", false, false, false, 61), "html", null, true);
            echo "</td>
                                                        <td style=\"vertical-align: middle\">";
            // line 62
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["status"], "name", [], "any", false, false, false, 62), "html", null, true);
            echo "</td>
                                                        <td style=\"vertical-align: middle\">";
            // line 63
            if ((twig_get_attribute($this->env, $this->source, $context["status"], "active", [], "any", false, false, false, 63) == 1)) {
                echo "Active";
            }
            if ((twig_get_attribute($this->env, $this->source, $context["status"], "active", [], "any", false, false, false, 63) == 0)) {
                echo "Disable";
            }
            echo "</td>
            ...
            if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, true, false, 67), "id", [], "any", true, true, false, 67)) {
                // line 68
                echo "                                                        <a href=\"status/show/";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["status"], "id", [], "any", false, false, false, 68), "html", null, true);
                ...
                // line 70
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["status"], "id", [], "any", false, false, false, 70), "html", null, true);
...
";
    ...
    {
        return "options/status.html.twig";
    }
                ...
                <div class=\"container-fluid\">
                    ...
                    <div class=\"row\">
                            ...
                            <div class=\"page-title-box\">
                                <div class=\"float-end\">
                                    <ol class=\"breadcrumb\">
                                        ...
                                        <li class=\"breadcrumb-item active\">{% trans %}Status{% endtrans %}</li>
                                    </ol>
                                </div>
                        ...
                        <form action=\"/options/status/create\">
                            ...
                            <button type=\"submit\" style=\"float:right\"class=\"btn btn-outline-secondary\">{% trans %}Create Status{% endtrans %}</button>
                        </form>
                        </div>
                        ...
                        <div class=\"col-12\">
                            <div class=\"card\">
                                <div class=\"card-header\">
                                    <div class=\"row align-items-center\">
                                        <div class=\"col\">                      
                                            <h4 class=\"card-title\">{% trans %}Status Details{% endtrans %}</h4>             
                                        </div><!--end col-->                                       
                                    </div>  <!--end row-->                                  
                                </div><!--end card-header-->
                                <div class=\"card-body\">                                    
                                        ...
                                        <table class=\"table mb-0\">
                                            ...
                                            <tbody id=\"myTable\">
                                                    ...
                                                    {% for status in status %}
                                                        ...
                                                        <td style=\"vertical-align: middle\">{% if status.active == 1 %}Active{% endif %}{% if status.active == 0 %}Disable{% endif %}</td>

                                                        <td style=\"-webkit-user-select: none; vertical-align: middle\">
  
                                                        {% if app.user.id is defined%}
                                                        <a href=\"status/show/{{ status.id }}\"><i class=\"mdi mdi-eye-outline text-secondary font-16\"></i></a>
                                                        <a href=\"status/edit/{{ status.id }}\"><i class=\"las la-pen text-secondary font-16\"></i></a>
                                                        <a href=\"status/delete/{{ status.id }}\"><i class=\"las la-trash-alt text-secondary font-16\" onclick=\"return confirm('are you sure?')\"></i></a>
                                                        {% endif %}
                                                        </td>
                                                    </tr>
                                                    {% endfor %}
...
{% endblock %} ", "options/status.html.twig", "C:\\Users\\RuiMiguelCarvalhoBen\\Documents\\symfony-cli\\my_project\\templates\\options\\status.html.twig");
    }
}
