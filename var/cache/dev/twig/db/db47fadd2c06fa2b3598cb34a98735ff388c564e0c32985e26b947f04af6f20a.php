...
/* options/area.html.twig */
class __TwigTemplate_f29c6930581159b03a883a0ba326a7cf1a7f1c558b9890176b155ee1e8903925 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "options/area.html.twig"));

        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02 = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "options/area.html.twig"));

        $this->parent = $this->loadTemplate("base.html.twig", "options/area.html.twig", 1);
   ...
   <div class=\"page-wrapper\">
        ...
        echo "</h4>
                        ...
                        <form action=\"/options/area/create\">
        ...
        // line 31
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Create Area", [], "messages");
        echo "</button>
                        </form>
                        </div>
                                ...
                                <div class=\"card-header\">
                                    <div class=\"row align-items-center\">
                                        <div class=\"col\">                      
                                            <h4 class=\"card-title\">";
        // line 41
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Area Details", [], "messages");
        echo "</h4>             
                                        </div><!--end col-->                                       
                                    </div>  <!--end row-->                                  
                                </div><!--end card-header-->
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["area"]) {
            ...
            // line 61
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["area"], "id", [], "any", false, false, false, 61), "html", null, true);
            echo "</td>
                                                        <td style=\"vertical-align: middle\">";
            // line 62
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["area"], "name", [], "any", false, false, false, 62), "html", null, true);
            echo "</td>
                                                        <td style=\"vertical-align: middle\">";
            // line 63
            if ((twig_get_attribute($this->env, $this->source, $context["area"], "active", [], "any", false, false, false, 63) == 1)) {
                echo "Active";
            }
            if ((twig_get_attribute($this->env, $this->source, $context["area"], "active", [], "any", false, false, false, 63) == 0)) {
                echo "Disable";
            }
            echo "</td>
            ...
            if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, true, false, 67), "id", [], "any", true, true, false, 67)) {
                // line 68
                echo "                                                            <a href=\"area/show/";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["area"], "id", [], "any", false, false, false, 68), "html", null, true);
                echo "\"><i class=\"mdi mdi-eye-outline text-secondary font-16\"></i></a>
                                                            <a href=\"area/edit/";
                // line 69
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["area"], "id", [], "any", false, false, false, 69), "html", null, true);
                echo "\"><i class=\"las la-pen text-secondary font-16\"></i></a>
                                                            <a href=\"area/delete/";
                // line 70
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["area"], "id", [], "any", false, false, false, 70), "html", null, true);
                ...
                <div class=\"container-fluid\">
                    ...
                    <div class=\"row\">
                            ...
                            <div class=\"page-title-box\">
                                <div class=\"float-end\">
                                    <ol class=\"breadcrumb\">
                                        ...
                                        <li class=\"breadcrumb-item active\">{% trans %}Area{% endtrans %}</li>
                                    </ol>
                                </div>
                        ...
                        <form action=\"/options/area/create\">
                            ...
                            <button type=\"submit\" style=\"float:right\"class=\"btn btn-outline-secondary\">{% trans %}Create Area{% endtrans %}</button>
                        </form>
                        </div>
                        ...
                        <div class=\"col-12\">
                            <div class=\"card\">
                                <div class=\"card-header\">
                                    <div class=\"row align-items-center\">
                                        <div class=\"col\">                      
                                            <h4 class=\"card-title\">{% trans %}Area Details{% endtrans %}</h4>             
                                        </div><!--end col-->                                       
                                    </div>  <!--end row-->                                  
                                </div><!--end card-header-->
                                <div class=\"card-body\">                                    
                                        ...
                                        <table class=\"table mb-0\">
                                            ...
                                            <tbody id=\"myTable\">
                                                    ...
                                                    {% for area in area %}
                                                        ...
                                                        <td style=\"vertical-align: middle\">{{ area.id }}</td>
                                                        <td style=\"vertical-align: middle\">{{ area.name }}</td>
                                                        <td style=\"vertical-align: middle\">{% if area.active == 1 %}Active{% endif %}{% if area.active == 0 %}Disable{% endif %}</td>

                                                        <td style=\"-webkit-user-select: none; vertical-align: middle\">
  
                                                            {% if app.user.id is defined%}
                                                            <a href=\"area/show/{{ area.id }}\"><i class=\"mdi mdi-eye-outline text-secondary font-16\"></i></a>
                                                            <a href=\"area/edit/{{ area.id }}\"><i class=\"las la-pen text-secondary font-16\"></i></a>
                                                            <a href=\"area/delete/{{ area.id }}\"><i class=\"las la-trash-alt text-secondary font-16\" onclick=\"return confirm('are you sure?')\"></i></a>
                                                            {% endif %}
                                                        </td>
                                                    </tr>
                                                    {% endfor %}
...
{% endblock %} ", "options/area.html.twig", "C:\\Users\\RuiMiguelCarvalhoBen\\Documents\\symfony-cli\\my_project\\templates\\options\\area.html.twig");
    }
}
