 ...
 */
class AccountsType extends \App\Entity\AccountsType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AccountsType $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setName(string $name): \App\Entity\AccountsType
    {
     ...
     * {@inheritDoc}
     */
    public function setActive(bool $active): \App\Entity\AccountsType
    {
