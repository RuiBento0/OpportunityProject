 ...
 */
class getLocationsTypeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LocationsTypeRepository' shared autowired service.
     *
     * @return \App\Repository\LocationsTypeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LocationsTypeRepository.php';

        return $container->privates['App\\Repository\\LocationsTypeRepository'] = new \App\Repository\LocationsTypeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
