 ...
 */
class getUploadsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UploadsRepository' shared autowired service.
     *
     * @return \App\Repository\UploadsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UploadsRepository.php';

        return $container->privates['App\\Repository\\UploadsRepository'] = new \App\Repository\UploadsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
