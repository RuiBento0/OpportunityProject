 ...
 */
class getAccountsAreaRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AccountsAreaRepository' shared autowired service.
     *
     * @return \App\Repository\AccountsAreaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AccountsAreaRepository.php';

        return $container->privates['App\\Repository\\AccountsAreaRepository'] = new \App\Repository\AccountsAreaRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
