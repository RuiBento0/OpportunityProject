 ...
 */
class getAccountsTypeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AccountsTypeRepository' shared autowired service.
     *
     * @return \App\Repository\AccountsTypeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AccountsTypeRepository.php';

        return $container->privates['App\\Repository\\AccountsTypeRepository'] = new \App\Repository\AccountsTypeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
