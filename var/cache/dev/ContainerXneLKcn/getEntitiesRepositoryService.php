 ...
 */
class getEntitiesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EntitiesRepository' shared autowired service.
     *
     * @return \App\Repository\EntitiesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EntitiesRepository.php';

        return $container->privates['App\\Repository\\EntitiesRepository'] = new \App\Repository\EntitiesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
