 ...
 */
class getDepartmentsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DepartmentsRepository' shared autowired service.
     *
     * @return \App\Repository\DepartmentsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DepartmentsRepository.php';

        return $container->privates['App\\Repository\\DepartmentsRepository'] = new \App\Repository\DepartmentsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
