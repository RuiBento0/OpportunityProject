 ...
 */
class getAreaRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AreaRepository' shared autowired service.
     *
     * @return \App\Repository\AreaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AreaRepository.php';

        return $container->privates['App\\Repository\\AreaRepository'] = new \App\Repository\AreaRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
