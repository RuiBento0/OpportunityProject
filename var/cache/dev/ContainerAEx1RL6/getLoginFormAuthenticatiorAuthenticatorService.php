 ...
 */
class getLoginFormAuthenticatiorAuthenticatorService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Security\LoginFormAuthenticatiorAuthenticator' shared autowired service.
     *
     * @return \App\Security\LoginFormAuthenticatiorAuthenticator
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Security'.\DIRECTORY_SEPARATOR.'LoginFormAuthenticatiorAuthenticator.php';

        return $container->privates['App\\Security\\LoginFormAuthenticatiorAuthenticator'] = new \App\Security\LoginFormAuthenticatiorAuthenticator(($container->services['router'] ?? $container->getRouterService()));
    }
}
