 ...
 */
class getStagesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\StagesRepository' shared autowired service.
     *
     * @return \App\Repository\StagesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'StagesRepository.php';

        return $container->privates['App\\Repository\\StagesRepository'] = new \App\Repository\StagesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
