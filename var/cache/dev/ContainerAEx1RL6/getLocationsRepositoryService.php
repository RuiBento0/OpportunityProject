 ...
 */
class getLocationsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LocationsRepository' shared autowired service.
     *
     * @return \App\Repository\LocationsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LocationsRepository.php';

        return $container->privates['App\\Repository\\LocationsRepository'] = new \App\Repository\LocationsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
