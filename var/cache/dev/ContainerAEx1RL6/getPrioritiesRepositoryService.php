 ...
 */
class getPrioritiesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PrioritiesRepository' shared autowired service.
     *
     * @return \App\Repository\PrioritiesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PrioritiesRepository.php';

        return $container->privates['App\\Repository\\PrioritiesRepository'] = new \App\Repository\PrioritiesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
