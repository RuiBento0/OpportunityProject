 ...
 */
class getAccountsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AccountsRepository' shared autowired service.
     *
     * @return \App\Repository\AccountsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AccountsRepository.php';

        return $container->privates['App\\Repository\\AccountsRepository'] = new \App\Repository\AccountsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
