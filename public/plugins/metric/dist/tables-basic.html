                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table mb-0 table-centered">
                                        ...
                                        <tr>
                                            <td><img src="assets/images/small/project-3.jpg" alt="" class="rounded-circle thumb-xs me-1">
                                                Dairy Sweet
                                            </td>
                                            <td>6</td>
                                            <td>$210</td>
                                        ...
                                        <tr>
                                            <td><img src="assets/images/small/project-4.jpg" alt="" class="rounded-circle thumb-xs me-1">
                                                Corner Tea
                                            </td>
                                            <td>3</td>
                                            <td>$80</td>
