            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3">
                        <div class="card">
                            <img class="card-img-top img-fluid bg-light-alt" src="assets/images/small/img-4.jpg" alt="Card image cap">
                            <div class="card-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto">    
                                        <img class="rounded-circle" src="assets/images/users/user-7.jpg" alt="" height="24">                  
                        ...
                        <div class="card mb-3">
                            <div class="row no-gutters">
                                <div class="col-md-3 align-self-center text-center">
                                    <img class="" height="80" src="assets/images/small/btc.png" alt="Card image">
                                </div>
                                <div class="col-md-9">
                                    <div class="card-header">
                                        <div class="row align-items-center">
